...
const Navbar = () => {
  ...
  return (
    <nav className={`wapper`}>
      <div className="border-b-2 py-4 px-5 md:px-0 md:py-6  flex items-center justify-between overflow-hidden border-neutral-light-grayish-blue w-full">
        <div className=" flex items-center gap-5 md:gap-12">
          ...
          >
            ...
            >
              <button className="block md:hidden mt-12 mb-8" onClick={handle}>
